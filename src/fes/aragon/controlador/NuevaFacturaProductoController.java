...
public class NuevaFacturaProductoController implements Initializable {
	@FXML
	...
	@FXML // fx:id="idClienteFactura"
    private TableColumn<Clientes, Integer> idClienteFactura; 
	@FXML
	...
	public void accionGuardarFactura(MouseEvent event) {
		...
		try {
			...
			cnn.almacenarFacturasProductos(factpro);
	...
	public void accionLimpiar(MouseEvent event) {
		...
		public void initialize(URL arg0, ResourceBundle arg1) {
			...
			this.idClienteFactura.setCellValueFactory(new PropertyValueFactory<>("IdC"));
